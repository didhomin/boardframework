...
$(document).ready(function() {
	$('#writeBtn').click(function() {
		...
		$('#writeForm').attr('action','${root}/album/write.html').attr('method','post').submit();
	});
});
</script>
...
<table border="0" cellpadding="5" cellspacing="0" width="630"
	...
	<tr>
		<td width="95" nowrap style="padding-left: 8px; padding-top: 10px"><img
			src="${root}/img/board/e_dot.gif" width="4" height="4" border="0"
			align="absmiddle"> <b>글내용</b></td>
		<td width="620" nowrap style=" padding-top: 10px"
			colspan="5"><textarea id="content"
	...
	<tr>
		...
		<td width="" nowrap style=" padding-top: 10px"
			colspan="5"><input type="file" name="picture">
		</td>
	</tr>
</table>
